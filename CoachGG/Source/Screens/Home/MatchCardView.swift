        ...
        if let report = viewModel.endedMatchReport {
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 12) {
                    ...
                    Text(report.matchResume)
                        .font(.caption)
                        .foregroundStyle(ColorTheme.slate200)
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        ForEach(report.pros, id: \.self) { pro in
                            VStack(spacing: 4) {
                                HStack {
                        ...
                        ForEach(report.cons, id: \.self) { concern in
                            VStack(spacing: 4) {
                                HStack {
            ...
            .onChange(of: isReportVisible) {
                if isReportVisible {
                    withAnimation(.easeInOut(duration: 1)) {
                        reportContainerHeight = 400
                    }
            ...
            .overlay(alignment: .bottom) {
                HStack {
                    Text(isReportVisible ? "Minimizar" : "Maximizar")
                        .font(.caption)
                        .foregroundStyle(ColorTheme.slate300)
                    
                    Image(systemName: "chevron.up")
                        .rotationEffect(Angle(degrees: isReportVisible ? 0 : 180))
                        .font(.caption)
                        .foregroundStyle(ColorTheme.slate300)
                }
                ...
                .background(ColorTheme.slate700)
                .onTapGesture {
                    isReportVisible.toggle()
                    withAnimation(.easeIn(duration: 1)) {
                        reportContainerHeight = 28
                    }
                }
            }
